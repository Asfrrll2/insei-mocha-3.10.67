...
#ifndef _MACH_TEGRA_BOARD_MOCHA_H
#define _MACH_TEGRA_BOARD_MOCHA_H

#include <mach/irqs.h>
#include "gpio-names.h"

int mocha_emc_init(void);
int mocha_display_init(void);
int mocha_panel_init(void);
int mocha_sdhci_init(void);
int mocha_sensors_init(void);
int mocha_regulator_init(void);
int mocha_suspend_init(void);
int mocha_rail_alignment_init(void);
int mocha_soctherm_init(void);
int mocha_edp_init(void);
void shield_sysedp_dynamic_capping_init(void);
void mocha_camera_auxdata(void *);
